        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-foreground/20 backdrop-blur-sm">
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-serif font-bold text-foreground mb-2">Streak Broken</h2>
            ...
            <div className="space-y-3">
              {reasons.map((reason) => (
                <button
                  ...
                  className="w-full py-4 px-6 bg-muted hover:bg-muted-hover text-muted-foreground rounded-2xl font-medium transition-all shadow-sm hover:shadow-md active:scale-95 text-left flex justify-between items-center group"
                >
                  {reason}
